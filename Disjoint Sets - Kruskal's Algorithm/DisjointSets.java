...
public class DisjointSets {
    ...
    public int find(int i) {
    	if (par[i] == i) { //Base case, we have found the root of tree which is the representative of itself
    		return i;
    	}else {
	...
	public int union(int i, int j) {
		...
		if (find(i) != find(j)) { //check if representative of i and j are not equal (not in same set already)
